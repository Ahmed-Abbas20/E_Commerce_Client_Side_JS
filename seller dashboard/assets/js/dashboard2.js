$(function () {
      ...
      if (month >= 1 && month <= 12) {
        ...
        for (let i = 0; i < sellerorders[j].products.length; i++) {
          if (sellerorders[j].products[i].seller_id == cuurentseller.id) {
            console.log(sellerorders[j].products[i].costPrice);
            ordertotalprice +=
              sellerorders[j].products[i].price *
              sellerorders[j].products[i].quantity;
            ordertotalprofit +=
              (sellerorders[j].products[i].price -
                orders[j].products[i].costPrice) *
              sellerorders[j].products[i].quantity;
          }
        }
  ...
  for (let i = 0; i < sellerorders.length; i++) {
    if (sellerorders[i].status == "delivered") {
      deliverdorders++;
    } else if (sellerorders[i].status == "Pending") {
      penddingorders++;
    } else if (sellerorders[i].status == "inway") {
      inwayorders++;
    }
  }
  let statusorders = [deliverdorders, inwayorders, penddingorders];
  ...
  for (let i = 0; i < products.length; i++) {
    if (products[i].sellerid == cuurentseller.id) {
      ...
      tr.innerHTML = `     <td>
                      ...
                      <td>
                        <h5 class="mb-0">${products[i].sold}</h5>
                      </td>
    `;
  ...
  for (let i = 0; i < sellerorders.length; i++) {
    ...
    tr.innerHTML = `     <td>
                        <div class="">
                          <h6 class="mb-0">${sellerorders[i].order_id}</h6>
                      ...
                      <td>
                        <h5 class="mb-0">${
                          sellerorders[i].time.toString().split("T")[0]
                        }</h5>
                      </td>
    `;
